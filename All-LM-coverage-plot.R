...
setEPS()
postscript(file = paste("./Figures/plot-All-LM-sigma.varepsilon-",sigma.varepsilon,".eps",sep=""))
...
################
eta=0
outfile=paste("./Data/coverage-sigma.varepsilon-",sigma.varepsilon,"-All-LM-eta-",eta,".csv",sep="")
df=read.csv(outfile)
sol1=df$V2
sol2=df$V5
sol3=df$V8
...
legend('bottom',legend = c("Laspeyres","Paasche","Fisher",expression("Törnqvist"),"0.95"), col = c(1,2,3,4,1), 
       lty=c(1,2,3,4,2),lwd =c(3,3,3,3,1),xpd = TRUE,cex=1.6, ncol=5,bty = 'n')
